...
<body>
    ...
    <section class="home">
        <div class="cont">
            ...
            <div class="col-10 mx-auto my-5 bg-light rounded">
                ...
                <div class="col-sm-12 mx-auto p-5">
                    <center>
                        <h3><b>PROCESSOR MANAGEMENT</b></h3>
                    </center><br>
                    <div id="notif"></div><br />
                    <div class="row">
                        ...
                        <div class="col-sm-10 mb-2" align="right">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Processor</button>
      ...
      <td>$data[3]</td>
      <td>$data[4]</td>
      <td><a href=\"admin_processor_report.php?processorID=$data[0]\" ><i style=\"color:green;\" class='fa-regular fa-eye'></a></i></td> 
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" style="color: black;" id="staticBackdropLabel">Add Processor</h5><br>
                ...
                $.ajax({
                    ...
                    success: function(result, result1) {
                        if (result == 1) {
                            ...
                            $.ajax({
                                url: '../ajax/function_class.php?function=add_userprocessor',
                                type: 'POST',
                                data: {
                                    name: nameval,
                                    email: emailval,
