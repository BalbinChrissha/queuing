...
<body>
    ...
    <section class="home">
                ...
                <div class="col-sm-12 mx-auto p-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-10 mb-2" align="right">
                            ...
                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Add Window</button>
      ...
      <td>  <button type='button' id='update' class='eme'  style=' border: none; background-color: none;' data-id='$data[0]' data-name='$data[1]' data-desc='$data[2]' data-processor='$data[3]' data-status='$data[4]'   class='btn btn-success'><i  input type=\"edit\"  class=\"fa-solid fa-pen-to-square\" style=\"color:blue;\"></i></button>       
